...
PAYPAL_PAYOUT_SUBJECT = "You have a payout!"
PAYPAL_PAYOUT_MESSAGE = "You have received a payout! Thanks for using our service!"

PAYPAL_URL = secrets.get("PAYPAL-LIVE-URL")
PAYPAL_API_URL = secrets.get("PAYPAL-LIVE-API-URL")
PAYPAL_CLIENT_ID = secrets.get("PAYPAL-LIVE-CLIENT-ID")
PAYPAL_CLIENT_SECRET = secrets.get("PAYPAL-LIVE-CLIENT-SECRET")
